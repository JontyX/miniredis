...
func TestGeo(t *testing.T) {
	...
	testRaw(t, func(c *client) {
		...
		c.DoLoosly("GEORADIUSBYMEMBER", "stations", "Astor Pl", "4", "km", "WITHDIST")
		c.Do("GEORADIUSBYMEMBER", "stations", "Astor Pl", "4", "km", "WITHDIST", "ASC")
		c.DoLoosly("GEORADIUSBYMEMBER", "stations", "Astor Pl", "4", "km", "WITHCOORD")
		...
		c.DoLoosly("ZRANGE", "resd", "0", "-1", "WITHSCORES")
		...
		c.DoLoosly("ZRANGE", "resbymemd", "0", "-1", "WITHSCORES")
	})
}
